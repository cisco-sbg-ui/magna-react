...
components: ADrawer
title: ADrawer
usage: import { ADrawer } from '@cisco-sbg-ui/magna-react;
  ...
  return (
    <>
      ...
      >
        <AList className={bgColor} style={{ border: "none" }}>
          <AListItem
            title={isSlim ? "Expand toolbar" : "Shrink toolbar"}
            twoLine
          >
            <AListItemAvatar>
              <AButton
          ...
          <AListItem twoLine>
            ...
            <AListItemContent>Inbox</AListItemContent>
          </AListItem>
          <AListItem twoLine>
            <AListItemAvatar className="flex-shrink-0 mr-4">
              <AButton className="white--text" icon>
            ...
            <AListItemContent>Sent</AListItemContent>
          </AListItem>
          <AListItem twoLine>
            <AListItemAvatar className="flex-shrink-0 mr-4">
              <AButton className="white--text" icon>
            ...
            <AListItemContent>Trash</AListItemContent>
          </AListItem>
          <AListItem title="Close toolbar" twoLine>
            <AListItemAvatar className="flex-shrink-0 mr-4">
              <AButton
                className="coral--burnt-1 white--text"
            ...
            <AListItemContent>Close</AListItemContent>
          </AListItem>
        </AList>
      </ADrawer>
    </>
