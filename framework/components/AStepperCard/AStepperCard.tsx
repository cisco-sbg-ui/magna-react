...
const AStepperCard = forwardRef<HTMLDivElement, AStepperCardProps>(
  ({className: propsClassName = "", active, children, steps, ...rest}, ref) => {
    const baseClass = "a-stepper-card";
    return (
      <ACardContainer className={classnames(baseClass, "pa-0")} ref={ref} {...rest}> <ARow style={{height: "100%"}} noGutters>
        <ACol cols="4" className={classnames(`${baseClass}__card--col`, "text-center pr-0")}>
          <AStepper vertical>
