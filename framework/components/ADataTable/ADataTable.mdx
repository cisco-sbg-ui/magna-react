  ...
  return (
    <div
      ...
      <ADrawer
          ...
          openWidth='200px'
      >
        <ADrawerContent ref={drawerRef}>
          <h3 className='mt-0'>More Details</h3>
          <p>More information about {drawerContent?.c}.</p>
