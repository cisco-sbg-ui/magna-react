...
components: AActivityTimeline, AActivityTimelineItem
title: AActivityTimelineItem
...
<ComponentImport components="AActivityTimeline, AActivityTimelineItem" />
...
To make a timeline item collapsible, pass the `defaultCollapsed` prop, which will make the content you pass to `ActivityTimelineItemBody` toggle on timeline item clicks.
...
If you have special requirements for collapsing timeline items, you can control the state yourself. For example, suppose that only one timeline item can be opened at a time. In that case, you can pass the `isCollapsed` and `onToggle` props to the `AActivityTimelineItem` component:
...
<Playground
  ...
  <AActivityTimelineItem
    ...
    title={
      <AActivityTimelineItemTitle>
        <div>Wilderness is Rejuvenated</div>
  ...
  <AActivityTimelineItem
    ...
    title={
      <AActivityTimelineItemTitle>
        <div>Chambers of Xeric is Released</div>
  ...
  <AActivityTimelineItem
    ...
    title={
      <AActivityTimelineItemTitle>
        <div>Mobile Application is Released</div>
  ...
  <AActivityTimelineItem
    ...
    title={
      <AActivityTimelineItemTitle>
        <div>Theatre of Blood Released</div>
        <ATag color="accentB" small>
          PvM
        </ATag>
      </AActivityTimelineItemTitle>
